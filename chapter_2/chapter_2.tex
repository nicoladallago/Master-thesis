...
In this section we are going to introduce all the hardware and the software use in this project. Starting from the hardware, we used a main board develop entirely at LTU, the \textit{KFly}\footnote{https://gitlab.com/korken89/KFly}. 
