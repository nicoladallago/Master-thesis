...
\begin{figure}[h]
	...
	\end{tikzpicture}
	\caption{Block diagram of the quadrotor's dynamic. \textcolor{red}{Missing a line between omega and the dynamic}}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Quadrotor with the rotating platform in blue, in red the CoG of the quadrotor and in orange the resulting CoG. \textcolor{red}{align the figures with the center, not with the bottom}}
...
\noindent \textcolor{red}{Add the equation for the centrifugal force, and explain (with the computation) why is almost negligible, due to the slow rotation (6 rpm).}

\noindent \textcolor{red}{Other effects?}
