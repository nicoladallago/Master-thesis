...
\begin{equation}
	...
	\begin{bmatrix}
		...
		2q_1q_2+2q_0q_3         & 2q_2q_3-2q_0q_1         & q_0^2-q_1^2-q_2^2-q_3^2
	\end{bmatrix}
...
\noindent From the model \eqref{eq:finalModel1} the linear and angular accelerations are given, is then necessary to convert those to the world frame and integrate to obtain the position and orientation of the quadrotor with the respect to the world frame.
......
