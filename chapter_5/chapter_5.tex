...
\begin{align}
	...
	\boldsymbol{\tau} &= -k_R\mathbf{e}_R - k_{\omega}e_{\omega} + \omega\times I_{cm}\omega \label{eq:LeeController2} 
\end{align}
...
\begin{equation}
	...
	\begin{bmatrix}
		\dots   & A_F   & \dots  \\
		\dots & l_i\times\begin{bmatrix}0 \\ 0 \\ A_F \end{bmatrix}+\begin{bmatrix}0 \\ 0 \\ B_F\end{bmatrix} & \dots
	\end{bmatrix}^{-1}
